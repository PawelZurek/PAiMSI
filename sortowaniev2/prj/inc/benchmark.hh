 ...
 * -> wczytania dowolnego zestawu danych o ilosci elementow :
 *   \n-> 10
 *   \n-> 100
 *   \n-> 1000 
 *   \n-> 10000
 ...
 * \n	-> Merge Sort
 * \n	-> Heap Sort
 * \n Można jeszcze wybrać ile razy ma zostać wykonany program.
 ...
 *
 */
	benchmark(){ elapsedTime=0, czas = 0; czas_caly = 0; }
/*!
 *
 ...
 */
	void wyswietl_wszystko(double *c, double *q, double *m, double *h, int n, int s);
